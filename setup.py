...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-aeat_party_validation',
    download_url='https://github.com:nantic/trytond-aeat_party_validation.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-aeat_party_validation.git'
    },
    classifiers=[
